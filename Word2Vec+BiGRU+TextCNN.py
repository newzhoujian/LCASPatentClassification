...
with tf.device('/gpu:0'):
    ...
    for i in filter_size:
        conv_layer = Conv1D(filters=300, kernel_size=i)(sen2vec)
    ...
    model.summary()
    checkpoint = ModelCheckpoint('../../PCmodel/Word2VecBiGRUTextCNN.h5', monitor='val_categorical_accuracy', verbose=1, save_best_only=True, mode='max')
    ...
    model.save('../../PCmodel/Word2VecBiGRUTextCNN.h5')
