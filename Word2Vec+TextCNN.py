...
with tf.device('/gpu:0'):
    ...
    for i in filter_size:
        conv_layer = Conv1D(filters=300, kernel_size=i)(wordembed)
    ...
    model.summary()
    checkpoint = ModelCheckpoint('../../PCmodel/Word2VecTextCNN.h5', monitor='val_categorical_accuracy', verbose=1, save_best_only=True, mode='max')
    ...
    model.save('../../PCmodel/Word2VecTextCNN.h5')
