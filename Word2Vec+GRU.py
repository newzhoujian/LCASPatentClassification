...
with tf.device('/gpu:0'):
    ...
    model.summary()
    checkpoint = ModelCheckpoint('../../PCmodel/Word2VecGRU.h5', monitor='val_categorical_accuracy', verbose=1, save_best_only=True, mode='max')
    ...
    model.save('../../PCmodel/Word2VecGRU.h5')
